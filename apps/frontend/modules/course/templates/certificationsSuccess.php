...
*/
		...
		if($mhr_usr_institution) {
			$cert_reg_paid_status[$library_list_key]["paid_flag"] = 1; // correct 1;
		} else {
			$cert_reg_paid_status[$library_list_key]["paid_flag"] = 0; // correct 0;
		}
...
foreach($cert_products_details as $cert_products_detail_key=>$cert_products_detail_val)
{
	...
	?>
		<div class="col-md-4">
			<a class="" href="#cert_<?php echo $cert_products_detail_val["short_name"] ?>">
...
foreach($cert_products_details as $products_detail_key=>$products_detail_val) {
	...
	?>	
		<div class="panel panel-success">
			...
			<a name="cert_<?php echo $products_detail_val["short_name"]; ?>"></a>
				<div class="row">
					<div class="col-md-6">
					<p>
